...
if (!class_exists('wp_pluginbase_v2_2')) {

    abstract class wp_pluginbase_v2_2 {
		...
		do_action($this->plugin_slug.'_admin_settings_init', $this);
	}
        ...
        function admin_settings_render( $args = array() ) {
          ...
          switch ( $type ) {
            ...
            case 'license':
              ...
              echo '<input class="regular-text license-input '.$class.'" type="password" id="' . $id . '" name="'.$this->plugin_slug.'[' . $id . ']" value="' . esc_attr($options[$id]) . '" />';
              echo '<input class="license-check-button" type="button" name="license_button" value="' . __('Validate', $this->plugin_slug) . '" />';
              echo '<span style="display:none" class="license-nonce">' . wp_create_nonce( 'ajax-license-nonce' ) . '</span>';
...
//            }
        ...
        function admin_settings_add_menu() {
          if ($this->has_settings) {
            ...
            $title = $this->plugin_title . __(' Settings', $this->plugin_slug);
        ...
        function admin_settings_render_page() {
          ...
          if (file_exists($this->plugin_dir . "settings.php")) {
            ...
            include_once($this->plugin_dir . "includes/wp_pluginbase_v2_2_default_settings.php");

            $settings_summary = $this->apply_filters('settings_summary', '');
            $settings_title = $this->get_settings_title();

            wp_pluginbase_v2_2_default_settings::render( $settings_title, $settings_summary, $this->plugin_slug, $this->_settings_tabs);
          }
        }
